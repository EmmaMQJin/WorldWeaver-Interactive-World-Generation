('Costco Entrance', 'east', 'Bakery Aisle', 
    '''
...
('Produce Aisle', 'out', 'Costco Parking Lot', 
    '''
...
('Security Guard Station', 'east', 'Costco Parking Lot', 
    '''
...
('Bakery Aisle', 'west', 'Costco Entrance', 
    '''
...
('Checkout Lane', 'east', 'Costco Entrance', 
    '''
...
('Costco Exit', 'south', 'Costco Entrance', 
    '''
