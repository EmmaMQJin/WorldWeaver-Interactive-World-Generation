...
# Exit Costco"""
    ...
    # data_obj = WorldWeaver.from_primitive(deepcopy(data), custom_actions=[Exit, Navigate, Find], custom_blocks=[RoyalBallroomEastBlock,MysteriousHallwayEastBlock,WizardsTowerDownBlock,FancyBanquetTableWestBlock,QueensThroneWestBlock,RewardRoomEastBlock])
