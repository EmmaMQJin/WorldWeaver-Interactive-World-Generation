...
def generate_blocks(background_story, action_list, all_locations_path, directory = "../data"):
    ...
    prompt = ("You are a helpful playthrough block generator for text adventure games. " 
            "Your job is to create blocks in some of the locations of the game so that the user needs to complete a task or puzzle to go forward. "
             ...
             "Write python code based on the blocks you generate, including the methods _init_, is_blocked, and from_primitive.")
    ...
    prompt = (
        ...
        "Each class should inherit from blocks.Block, and contain _init_, is_blocked, and from_primitive as methods.",
        "The from_primitive method should take a dictionary as input and return an instance of the class, "
        "properly initializing all the class attributes using the dictionary values.",
